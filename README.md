...
- **版本**：v1.1.5
- **构建 Commit**：`f8ae395`
- **构建时间**：2026-09-09 12:23:25
- **IPA SHA256**：`3057164e346b3b08efe93b97dd9031b34c4bca4665a54c28341427f5c4aa8d0c`
...
- **版本**：v1.1.4
- **构建 Commit**：`ebb598b`
- **构建时间**：2026-09-09 12:07:05
- **IPA SHA256**：`288a2ca717887c7af79aa52af73baab46e98cc4921ad2f4b10c85cc083e23bfc`
...
- **版本**：v1.1.3
- **构建 Commit**：`4a6a439`
- **构建时间**：2026-09-09 11:59:45
- **IPA SHA256**：`de678d78aed0afeb7ed43dfce73c6f4c613ca6bd3357ecabca46d251a6eec49f`
...
- **版本**：v1.1.2
- **构建 Commit**：`6e75dc3`
- **构建时间**：2026-09-09 11:52:42
- **IPA SHA256**：`036806c4bc523f8b73731891285ddcfde7f0772103e5c2a03d03dfda8b182d0a`



### v1.0.47（最新 · 新增手势灵敏度管理）
- **新增手势灵敏度设置页**：设置 → 手势灵敏度，独立调节边缘返回/前进与下拉刷新的触发阈值
- **边缘手势灵敏度**：滑块 40-100pt，值越小越跟手，默认 60pt
- **下拉刷新灵敏度**：滑块 50-120pt，值越小越容易触发刷新，默认 80pt
- 设置实时生效，无需重启应用

### v1.0.46（新增上半屏下拉刷新）
- **新增下拉刷新**：仅上半屏区域识别下拉手势，页面在顶部时下拉超过 80pt 触发刷新，显示圆形刷新指示器
- **保留轻下拉聚焦地址栏**：上半屏轻下拉（30-80pt）聚焦地址栏，与下拉刷新阈值区分
